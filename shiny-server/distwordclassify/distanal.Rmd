...
Then it will create a table of frequencies that represent how often each word occur with other words.  For example, _boy_ occurs with _good_ before it 1784 times and this will cause it to be classified with other words that also occur with _good_ before them.  The CA will have various
