...
ga('send', 'pageview');")),
    ...
    ,column(2,selectInput("yaxis", "Y-axis",
                              choices = c("Dim2")))
    ,column(2,downloadButton('downloadFit', 'Download CA Table'))
    )
    ,plotOutput("logrank")
     ),
...
- To cite these tools, please use this reference: Chang, F. (2017) The LuCiD language researcher's toolkit [Computer software]. Retrieved from http://www.lucid.ac.uk/resources/for-researchers/toolkit/ test
