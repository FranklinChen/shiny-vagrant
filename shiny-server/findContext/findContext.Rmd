...
- This program allows you to find utterances that match some criteria and see the context associated with them.
- Type a regular expression in the find box and select the column that you want to search (select w for the word/utterance).
...
#    print(unique(vdf$t_type))
  ...
  observe({
   ...
   #   values$debug = paste(input$col1,"__",input$search1,"__",sep="")
